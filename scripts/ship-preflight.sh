...
echo "  [ ] migration parity checked against staging + production by default; production under the active dated exception (npm run db:parity)"
echo "  [ ] default: ff-only main → staging, QA sign-off, staging → production; exception: docs/agents/temporary-direct-production-policy.json"
