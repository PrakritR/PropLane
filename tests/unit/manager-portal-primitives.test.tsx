...
describe("BulkActionBar", () => {
  ...
  it("shows the selected count and actions in normal document flow", () => {
    render(
  ...
  it("hideCount avoids repeating the parent toolbar count", () => {
    render(
  ...
  it("shows a custom selection count label", () => {
    render(
