...
- The workspace initialization and locking implementation reviewed here was superseded; see [`20260916030000_workspace_delete_any.sql`](../../supabase/migrations/20260916030000_workspace_delete_any.sql) for the current RPC contract.
