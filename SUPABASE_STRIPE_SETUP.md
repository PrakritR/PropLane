...
- [ ] When lifetime waiver promos should work in production, set `PROPLANE_PAYMENT_WAIVER_CODE` to a strong random comp code (never the public `FREE100` literal). Production grants no waiver when unset.
