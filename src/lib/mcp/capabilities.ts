...
export const API_KEY_PRODUCT_AREAS: readonly ApiKeyProductArea[] = [
  {
    ...
    readTools: ["list_properties", "get_property_details", "get_property_links", "get_listing_creation_checklist", "get_listing_media_inventory", "list_residents", "list_inspections", "get_inspection", "list_documents", "list_co_managers", "list_portfolio_imports", "get_portfolio_import"],
    writeTools: ["create_property", "update_property", "update_room_rent", "update_property_lease_config", "copy_listing_photos", "share_property_link", "create_listing_draft", "update_listing_draft", "apply_listing_photos", "set_resident_approval", "send_resident_welcome", "revoke_resident_access", "record_move_out", "open_inspection", "save_inspection_observations", "file_inspection_photo", "commit_portfolio_import", "invite_imported_residents"],
  },
  {
    id: "leasing",
