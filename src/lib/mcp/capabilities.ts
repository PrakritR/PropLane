...
export const API_KEY_PRODUCT_AREAS: readonly ApiKeyProductArea[] = [
  {
    ...
    readTools: ["list_properties", "get_property_details", "get_property_links", "get_listing_creation_checklist", "get_listing_media_inventory", "listing_syndication_status", "list_residents", "list_inspections", "get_inspection", "list_documents", "list_co_managers"],
