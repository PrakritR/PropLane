 ...
 * manager typed to their most-recently-active resident thread, which they had
 * never been shown (Leg 1 forwarding is disabled in the managed regime, see
 * below), so the target was effectively a guess. Reaching a resident is now an
