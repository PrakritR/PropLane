...
const APPLICATION_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    resumeUrl: "https://proplane.ai/resident/applications",
  },
...
const APPLICATION_MANAGER_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    applicantName: "Alex Prospect",
    propertyTitle: "5257 Brooklyn Avenue Northeast",
    url: "https://proplane.ai/portal/applications",
  },
...
const APPLICATION_POST_TOUR_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    applicantName: "Alex Prospect",
    propertyTitle: "5257 Brooklyn Avenue Northeast",
    applyUrl: "https://proplane.ai/rent/apply",
...
const LEASE_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    propertyTitle: "5257 Brooklyn Avenue Northeast",
    leaseUrl: "https://proplane.ai/resident/lease",
...
const LEASE_MANAGER_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    residentName: "Jamie Resident",
    propertyTitle: "5257 Brooklyn Avenue Northeast",
    url: "https://proplane.ai/portal/leases",
  },
  recipientPreview: "Your team",
};
...
const PAYMENT_MANAGER_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    url: "https://proplane.ai/portal/payments",
  },
  recipientPreview: "Your team",
};
...
const TOUR_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    url: "https://proplane.ai/portal/tours",
  },
  recipientPreview: "Your team",
};
...
const TASK_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    duePhrase: "in 1 day",
    url: "https://proplane.ai/portal/tasks",
  },
  recipientPreview: "Your team",
};
...
const SERVICE_ORDER_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    duePhrase: "in 1 day",
    url: "https://proplane.ai/portal/services",
  },
  recipientPreview: "Your team",
};
...
const OUTGOING_PAYMENT_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    duePhrase: "in 3 days",
    url: "https://proplane.ai/portal/finances",
  },
  recipientPreview: "Your team",
};
...
const BOOKING_META: ReminderSubjectSettingsMeta = {
  ...
  previewContext: {
    ...
    duePhrase: "in 1 day",
    url: "https://proplane.ai/portal/bookings/upcoming",
  },
  recipientPreview: "Your team",
};
...
const PLAN_0915_META: Partial<Record<ReminderSubjectKind, ReminderSubjectSettingsMeta>> = {
  ...
  vendor_offer_expiry: compactMeta({ directions: ["before"], timingLabel: "Nudge before the offer expires", counterparty: "Vendor", recipientPreview: "Juniper Services",
    subject: "Your offer for {title} expires {duePhrase}", body: ["Your offer for “{title}” at {propertyTitle} expires {whenLabel}.", "", "Accept or decline it: {url}"], preview: { url: "https://proplane.ai/vendor/work-orders" } }),
  vendor_invoice_nudge: compactMeta({ directions: ["after"], timingLabel: "Nudge after marked done", counterparty: "Vendor", recipientPreview: "Juniper Services",
    subject: "Invoice for {title}?", body: ["You marked “{title}” at {propertyTitle} done {duePhrase}. Submit your invoice when you are ready.", "", "{url}"], preview: { url: "https://proplane.ai/vendor/financials/invoices" } }),
  invoice_approval: compactMeta({ directions: ["after"], timingLabel: "Remind after the invoice arrives", counterparty: "Vendor", recipientPreview: "Your team",
    subject: "Invoice waiting: {title}", body: ["{counterpartyName}’s {amountLabel} invoice arrived {duePhrase} and has not been decided.", "", "Review it: {url}"], preview: { counterpartyName: "Juniper Services", title: "Juniper Services’s $180.00 invoice", url: "https://proplane.ai/portal/finances" } }),
  service_request_decision: compactMeta({ directions: ["after"], timingLabel: "Remind after submitted", counterparty: "Resident", recipientPreview: "Your team",
    subject: "Add-on request waiting: {title}", body: ["{counterpartyName}’s request for “{title}” has waited {duePhrase}.", "", "Decide: {url}"], preview: { title: "Parking", url: "https://proplane.ai/portal/services/requests" } }),
  service_request_unpaid: compactMeta({ directions: ["after"], timingLabel: "Remind after approved", counterparty: "Resident",
    subject: "Pay to activate {title}", body: ["“{title}” is approved — pay {amountLabel} to activate it.", "", "{url}"], preview: { title: "Parking", amountLabel: "$75.00", url: "https://proplane.ai/resident/payments" } }),
  ...
  lease_ending_manager: compactMeta({ directions: ["before"], timingLabel: "Remind me before the end", counterparty: "Resident", recipientPreview: "Your team",
    subject: "{counterpartyName}’s lease ends {duePhrase}", body: ["{counterpartyName}’s lease at {propertyTitle} ends on {dueDateLabel}. Renew, go month-to-month, or give notice.", "", "{url}"], preview: { dueDateLabel: "Nov 30, 2026", duePhrase: "in 90 days", url: "https://proplane.ai/portal/leases" } }),
  renewal_offer_expiry: compactMeta({ directions: ["before"], timingLabel: "Remind before the offer expires", counterparty: "Resident",
    subject: "Your renewal offer expires {duePhrase}", body: ["Your renewal offer for {propertyTitle} expires on {dueDateLabel}. Accept or decline it here:", "{url}"], preview: { dueDateLabel: "Nov 15, 2026", duePhrase: "in 3 days", url: "https://proplane.ai/resident/lease" } }),
  countersign_overdue: compactMeta({ directions: ["after"], timingLabel: "Remind after the resident signed", counterparty: "Resident", recipientPreview: "Your team",
    subject: "{counterpartyName}’s lease is waiting on your signature", body: ["{counterpartyName} signed the lease for {propertyTitle} {duePhrase}. It is waiting on your countersignature.", "", "{url}"], preview: { duePhrase: "2 days ago", url: "https://proplane.ai/portal/leases" } }),
  move_in: compactMeta({ directions: ["before"], timingLabel: "Remind before move-in", counterparty: "Resident",
    subject: "Moving in {dueDateLabel} — your checklist", body: ["You move into {propertyTitle} on {dueDateLabel} ({duePhrase}).", "• Keys and arrival time", "• Utilities in your name from move-in day", "• Renters insurance on file", "• First payment due on move-in", "", "House info: {url}"], preview: { dueDateLabel: "Sat, Dec 1", duePhrase: "in 7 days", url: "https://proplane.ai/resident/my-home" } }),
  ...
  move_out_inspection_manager: compactMeta({ directions: ["before"], timingLabel: "Remind me before move-out", counterparty: "Resident", recipientPreview: "Your team",
    subject: "Schedule {counterpartyName}’s move-out inspection", body: ["{counterpartyName} moves out of {propertyTitle} on {dueDateLabel}. Schedule the move-out inspection.", "", "{url}"], preview: { dueDateLabel: "Nov 30, 2026", url: "https://proplane.ai/portal/inspections" } }),
  deposit_accounting: compactMeta({ directions: ["before"], timingLabel: "Remind me before the deadline", counterparty: "Resident", recipientPreview: "Your team",
    subject: "{counterpartyName}’s deposit accounting is due {duePhrase}", body: ["The deposit accounting for {counterpartyName} ({propertyTitle}) is due on {dueDateLabel}.", "", "Prepare it: {url}"], preview: { dueDateLabel: "Dec 21, 2026", duePhrase: "in 14 days", url: "https://proplane.ai/portal/payments" } }),
  ...
  move_out_instructions: compactMeta({ directions: ["before"], timingLabel: "Send before move-out", counterparty: "Resident",
    subject: "Moving out {dueDateLabel} — what to do", body: ["Your move-out date is {dueDateLabel} ({duePhrase}).", "• Return all keys", "• Leave the room clean and empty", "• Give us a forwarding address", "", "{url}"], preview: { dueDateLabel: "Nov 30, 2026", duePhrase: "in 14 days", url: "https://proplane.ai/resident/lease" } }),
  deposit_return_notice: compactMeta({ directions: ["before"], timingLabel: "Send on move-out day", counterparty: "Resident",
    subject: "Your deposit is being processed", body: ["Today is your move-out date at {propertyTitle}. Your security deposit accounting will follow once the move-out inspection is complete.", "", "{url}"], preview: { url: "https://proplane.ai/resident/payments" } }),
  // ---- Applications ----
  application_documents: compactMeta({ directions: ["after"], timingLabel: "Remind after requested", counterparty: "Applicant", recipientPreview: "Alex Prospect",
    subject: "Documents still needed for {propertyTitle}", body: ["Your property manager asked for {title} {duePhrase} and has not received it yet.", "", "Upload: {url}"], preview: { title: "pay stubs (last 2)", duePhrase: "2 days ago", url: "https://proplane.ai/resident/applications" } }),
  application_decision_manager: compactMeta({ directions: ["after"], timingLabel: "Remind after submitted", counterparty: "Applicant", recipientPreview: "Your team",
    subject: "Decision waiting: {counterpartyName}", body: ["{counterpartyName}’s application for {propertyTitle} was submitted {duePhrase} and has no decision.", "", "{url}"], preview: { counterpartyName: "Alex Prospect", duePhrase: "3 days ago", url: "https://proplane.ai/portal/applications" } }),
  application_no_lease_manager: compactMeta({ directions: ["after"], timingLabel: "Remind after approval", counterparty: "Applicant", recipientPreview: "Your team",
    subject: "{counterpartyName} is approved but has no lease", body: ["You approved {counterpartyName} for {propertyTitle} {duePhrase}; no lease has been sent.", "", "Create one: {url}"], preview: { counterpartyName: "Alex Prospect", duePhrase: "2 days ago", url: "https://proplane.ai/portal/leases" } }),
  cosigner: compactMeta({ directions: ["after"], timingLabel: "Remind after invited", counterparty: "Cosigner", recipientPreview: "Jordan Cosigner",
    subject: "Cosigner form for {counterpartyName}", body: ["{counterpartyName} listed you as a cosigner for {propertyTitle} {duePhrase}. The form has not been completed yet.", "", "{url}"], preview: { counterpartyName: "Alex Prospect", duePhrase: "2 days ago", url: "https://proplane.ai/cosign" } }),
  group_application: compactMeta({ directions: ["after"], timingLabel: "Remind after the first member applied", counterparty: "Applicant", recipientPreview: "Sam Roommate",
    subject: "Add your application for {propertyTitle}", body: ["{counterpartyName} applied to {propertyTitle} as a group {duePhrase}. Your own application is still missing.", "", "Apply: {url}"], preview: { counterpartyName: "Alex Prospect", duePhrase: "2 days ago", url: "https://proplane.ai/apply" } }),
  // ---- Tours ----
  tour_request_unanswered: compactMeta({ directions: ["after"], timingLabel: "Remind after the request", counterparty: "Guest", recipientPreview: "Your team",
    subject: "Tour request waiting: {counterpartyName}", body: ["{counterpartyName} asked for a tour of {propertyTitle} on {whenLabel}, {duePhrase}. Confirm or propose another time.", "", "{url}"], preview: { counterpartyName: "Alex Prospect", duePhrase: "4 hours ago", url: "https://proplane.ai/portal/tours" } }),
  tour_request_reoffer: compactMeta({ directions: ["after"], timingLabel: "Offer other times after", counterparty: "Guest", recipientPreview: "Alex Prospect",
    subject: "Pick another time to tour {propertyTitle}", body: ["We could not confirm {whenLabel} yet. Pick another time that works:", "{url}"], preview: { url: "https://proplane.ai/tour" } }),
  tour_no_show_manager: compactMeta({ directions: ["after"], timingLabel: "Ask me after the tour ended", counterparty: "Guest", recipientPreview: "Your team",
    subject: "Did {counterpartyName} tour {propertyTitle}?", body: ["{counterpartyName}’s tour of {propertyTitle} was at {whenLabel}. Mark it toured or a no-show.", "", "{url}"], preview: { counterpartyName: "Alex Prospect", url: "https://proplane.ai/portal/tours" } }),
  tour_feedback: compactMeta({ directions: ["after"], timingLabel: "Ask after the tour", counterparty: "Guest", recipientPreview: "Alex Prospect",
    subject: "How was your tour of {propertyTitle}?", body: ["Thanks for touring {propertyTitle} today. A quick rating helps us:", "{url}"], preview: { url: "https://proplane.ai/tour/feedback" } }),
  ...
  delinquency_manager: compactMeta({ directions: ["after"], timingLabel: "Remind after due", counterparty: "Resident", recipientPreview: "Your team",
    subject: "{counterpartyName} is {duePhrase} late", body: ["{counterpartyName}’s {title} of {amountLabel} at {propertyTitle} is {duePhrase} past due.", "", "Review and send a notice if needed: {url}"], preview: { title: "December rent", amountLabel: "$1,900.00", duePhrase: "10 days", url: "https://proplane.ai/portal/payments" } }),
  message_unanswered: compactMeta({ directions: ["after"], timingLabel: "Remind after the message", counterparty: "Resident", recipientPreview: "Your team",
    subject: "Unanswered: {counterpartyName}", body: ["{counterpartyName} wrote {duePhrase} and has not had a reply: “{title}”", "", "Reply: {url}"], preview: { title: "Is the dryer supposed to make that noise?", duePhrase: "1 day ago", url: "https://proplane.ai/portal/communication" } }),
  document_signature: compactMeta({ directions: ["after"], timingLabel: "Remind after requested", counterparty: "Signer",
    subject: "“{title}” is waiting for your signature", body: ["Your property manager asked you to sign “{title}” {duePhrase}.", "", "Sign it: {url}"], preview: { title: "Pet addendum", duePhrase: "3 days ago", url: "https://proplane.ai/resident/documents" } }),
  task_overdue: compactMeta({ directions: ["after"], timingLabel: "Remind after due", counterparty: "Assignee", recipientPreview: "Jordan Team",
    subject: "Overdue: {title}", body: ["“{title}” was due {dueDateLabel} and is {duePhrase} overdue.", "", "{url}"], preview: { title: "Replace hallway bulb", dueDateLabel: "Sep 17, 2026", duePhrase: "1 day", url: "https://proplane.ai/portal/tasks" } }),
