...
export const PORTAL_EMPTY_COPY = {
  ...
  "work-orders.pending": T("No services pending", "work-orders"),
  "work-orders.upcoming": T("Nothing upcoming", "work-orders"),
  "work-orders.past": T("No past services", "work-orders"),
