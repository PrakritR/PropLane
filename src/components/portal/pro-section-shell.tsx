...
import { PORTAL_PAGE_TITLE, PORTAL_PAGE_TITLE_HIDDEN, PortalKpiTabStrip } from "@/components/portal/portal-metrics";
  ...
  return (
    <div className="relative z-0 flex min-h-0 w-full max-w-full flex-1 flex-col max-lg:flex-none">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <h1 className={cn(PORTAL_PAGE_TITLE, PORTAL_PAGE_TITLE_HIDDEN && "sr-only")}>{title}</h1>
