...
const SUBJECT_DIRECTIONS: Record<ReminderSubjectKind, TimingDirection[]> = {
  ...
  work_order_unassigned: ["after"],
  work_order_unassigned_emergency: ["after"],
  work_order_no_on_my_way: ["after"],
  vendor_offer_expiry: ["before"],
  vendor_invoice_nudge: ["after"],
  invoice_approval: ["after"],
  service_request_decision: ["after"],
  service_request_unpaid: ["after"],
  vendor_document_expiry: ["before"],
  lease_ending: ["before"],
  lease_ending_manager: ["before"],
  renewal_offer_expiry: ["before"],
  countersign_overdue: ["after"],
  move_in: ["before"],
  move_in_payment_method: ["before"],
  move_out: ["before"],
  move_out_inspection_manager: ["before"],
  deposit_accounting: ["before"],
  application_documents: ["after"],
  application_decision_manager: ["after"],
  application_no_lease_manager: ["after"],
  cosigner: ["after"],
  group_application: ["after"],
  tour_request_unanswered: ["after"],
  tour_request_reoffer: ["after"],
  tour_no_show_manager: ["after"],
  tour_feedback: ["after"],
  delinquency_manager: ["after"],
  message_unanswered: ["after"],
  document_signature: ["after"],
  task_overdue: ["after"],
  resident_welcome: ["after"],
  inspection_acknowledge: ["after"],
};
