...
import { computeVendorReviewAggregate, mapVendorReviewRow, VENDOR_REVIEW_SELECT } from "@/lib/vendor-reviews";

export const runtime = "nodejs";

/** The signed-in vendor's own reviews (unredacted — they're all about them), most recent first. */
