...
export const MANAGER_PLAN_TIERS: ManagerPlanTierDefinition[] = [
  {
    ...
    monthly: {
      headline: "Free",
      period: null,
      sub: "List one property, run applications and tours, and collect payments, with a shared inbox and a dedicated phone number.",
    },
    annual: {
      headline: "Free",
      period: null,
    ...
    features: [
      ...
      { text: "Dedicated phone number & texting", included: true },
